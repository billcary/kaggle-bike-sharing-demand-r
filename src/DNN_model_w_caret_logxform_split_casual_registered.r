...
grid <- expand.grid(layer1 = c(50, 100, 200), layer2 = c(50, 100, 200),
                    layer3 = c(50, 100, 200), hidden_dropout = 0,
                    visible_dropout = 0)
...
## Display
cat("\n\nNow training a DNN model for Casual Riders...\n")
...
## Display
cat("\n\nNow training a DNN model for Registered Riders...\n")
