...
## Pass Data to H2O
## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
train_h2o <- as.h2o(localH2O, processed_train, key = train_h2o)
test_h2o <- as.h2o(localH2O, processed_test, key = test_h2o)
...
for (n_label in 1:2) {
        ...
        raw_sub[, (n_label + 1)] <- as.matrix(h2o.predict(model, test_h2o))
