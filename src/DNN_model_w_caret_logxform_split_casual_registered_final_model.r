...
#          riders.  Train the models using log transforms.
...
final.gbm.casual.grid <- expand.grid(layer1 = c(100), layer2 = c(100),
                                     layer3 = c(100), hidden_dropout = 0,
                                     visible_dropout = 0)

final.gbm.registered.grid <- expand.grid(layer1 = c(100), layer2 = c(100),
                                         layer3 = c(100), hidden_dropout = 0,
                                         visible_dropout = 0)
