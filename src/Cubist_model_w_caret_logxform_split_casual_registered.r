...
#          riders.  Utilize Bernoulli distribution for counts.  Train models
#          using log transform.
...
## Display
cat("\n\nNow training a Cubist model for Casual Riders...\n")
...
## Display
cat("\n\nNow training a Cubist model for Registered Riders...\n")
